...
function seleccion(idArticulo) {
  $.getJSON("../../data.json", function (data) {
    ...
    pcArmada.push(articulo);

    switch (articulo.tipo) {
      case "Procesador":
        tienda.traerCompatible("AMD", "Motherboard");
        ...
        break;
      case "Motherboard":
        tienda.traerCompatible("AMD", "RAM");
        cargaProductos("RAM");
        procesarCarrito();
        ...
        break;
      case "RAM":
        tienda.traerCompatible("AMD", "SDD");
        ...
        break;
      case "SDD":
        tienda.traerCompatible("AMD", "HDD");
        ...
        break;
      case "HDD":
        tienda.traerCompatible("AMD", "PlacaVideo");
        ...
        break;
      case "PlacaVideo":
        tienda.traerCompatible("AMD", "Fuente");
        ...
        break;
      case "Fuente":
        tienda.traerCompatible("AMD", "Gabinete");
